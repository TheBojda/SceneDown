...
![timeline](assets/timeline.png){animation=slow-zoom transition=fade}
...
![spaceships](assets/spaceships.png){animation=slow-pan-right transition=fade}
...
![baseball](assets/baseball.png){animation=slow-zoom transition=cut}
...
![laser](assets/laser.png){animation=slow-zoom transition=fade}
